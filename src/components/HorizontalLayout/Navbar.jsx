                        ...
                        <Collapse isOpen={props.leftMenu} className="navbar-collapse" id="topnav-menu-content">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <div className={classname('dropdown-menu mega-dropdown-menu dropdown-menu-left dropdown-mega-menu-xl', { show: ui })}>
                                        <Row>
                                            <Col lg={4}>
                                                <div>
                                                    <Link to="#" className="dropdown-item">
                                        ...
                                        <div className="dropdown">
                                            ...
                                            <div className={classname('dropdown-menu', { show: job })}>
                                                ...
                                                <div className="dropdown">
                                                    ...
                                                    >
                                                        <span key="t-candidate">Candidate</span> <div className="arrow-down"></div>
                                                    </Link>
                                                    <div
                                                        className={classname('dropdown-menu', {
                                                            show: candidate
