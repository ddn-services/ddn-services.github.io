...
//actions
import { changeLayout, changeTopbarTheme, changeLayoutWidth, showRightSidebarAction } from '../../store/actions';
...
const Layout = (props) => {
    ...
    const { topbarTheme, layoutWidth, isPreloader, showRightSidebar } = useSelector((state) => ({
